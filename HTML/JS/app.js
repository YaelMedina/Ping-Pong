...
//Listeners
// Envía la posición de la paleta cuando se mueve
document.addEventListener('keydown', (e) => {
    switch (e.keyCode) {
        ...
        case 32://Barra espaciadora
            ball.isMoving = true;
            soundGame.play();
            socket.emit('handleMovement', { keyCode: e.keyCode});
            break;
        case 38: // Flecha arriba
            paddleRight.moveUp();
            socket.emit('paddleMove', { keyCode: e.keyCode, position: paddleRight.y });
            break;
